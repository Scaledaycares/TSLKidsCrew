...
function startConversation() {
    fetch('https://chatbot-for-tsl-kids-crew.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-tsl-kids-crew.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbxz529B9f5uNmpuPERcRrnVZhk-slQhFKHlXSvt3Imcm50Iy3EKpGbufn0ydXPT2mio/exec';
